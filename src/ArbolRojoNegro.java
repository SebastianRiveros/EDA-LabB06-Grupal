public class ArbolRojoNegro<T extends Comparable<T>> {
    ...
    private NodoRojoNegro<T> rotarDerecha(NodoRojoNegro<T> nodo) {
        NodoRojoNegro<T> aux = nodo.getIzquierda();  // Guarda el hijo izquierdo en una variable temporal
        ...
        return aux;  // Retorna el nodo temporal, que ahora es la nueva raíz (en caso de rotaciones)
    }
